...
export const AVATAR_MODEL_PARTS=Object.freeze([
 ...
 oval('face-mask',[0,2.105,-.194],[.17,.085,.06],'dark',{sides:22,rings:12}),
 oval('mask-seam',[0,2.095,-.252],[.11,.015,.01],'trim',{sides:18,rings:10}),
 ...
 oval('chest-panel-left',[.19,1.55,-.363],[.045,.15,.024],'metal',{mirror:true,sides:18,rings:10}),
 oval('collar-tab',[.22,1.855,-.194],[.07,.06,.04],'gold',{mirror:true,sides:18,rings:10}),
 ...
 oval('pack-light',[0,1.62,.478],[.1,.035,.021],'accent',{sides:18,rings:10}),
