...
for(const file of ['app.js','engine.js','network.js','network-tuning.js','drop-camera.js','render-buffer.js','simulation.js','connection-stability.js','multiplayer-runtime.js','index.html'])await access('dist/'+file);
